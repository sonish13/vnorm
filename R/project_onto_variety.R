...
#'   the sum of the squares of the Lagrangian. In the latter, the method of
...
#'   x0, p, gfunc = gfunc, dgfunc = dgfunc, ddgfunc = ddgfunc
#' )
#'
...
#' x0_proj_fixed <- project_onto_variety(
#'   x0, p, adaptive = FALSE, dt = 0.01, message = TRUE
#' )
#'
#' # Using stricter error tolerance for adaptive stepping
#' x0_proj_strict <- project_onto_variety(
#'   x0, p, error_tol = 0.01, message = TRUE
#' )
#'
#' # Visualize
...
#' grid_proj_gd <- project_onto_variety_gradient_descent(
#'   grid, p, method = "optimal"
#' )
...
#'   bind_cols(grid, grid_proj_gd) |>
#'     mutate(method = "optimal gradient descent"),
#'   bind_cols(grid, grid_proj_newton) |> mutate(method = "newton"),
#'   bind_cols(grid, grid_proj_lagrange) |>
#'     mutate(method = "newton on lagrangian")
#' )
#'
#'
#' ggplot() +
