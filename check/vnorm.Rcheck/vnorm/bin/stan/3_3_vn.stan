...
transformed parameters {
  real g = b1+bx*x+by*y+bz*z+bx2*x^2+by2*y^2+bz2*z^2+bxy*x*y+bxz*x*z+byz*y*z+bx3*x^3+by3*y^3+bz3*z^3+bx2y*x^2*y+bxy2*x*y^2+bx2z*x^2*z+by2z*y^2*z+bxz2*x*z^2+byz2*y*z^2+bxyz*x*y*z;
