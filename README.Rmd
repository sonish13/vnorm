...
The accompanying paper describes the variety normal distribution, projection and
sampling methods, and package applications in more detail. The README focuses on
the main user-facing workflow: sample, visualize, evaluate, and project.
...
- Schenck, Henry (2015). *Book Review: Numerically solving polynomial systems
  with Bertini*. *Bulletin of the American Mathematical Society*, 53(1),
  179--186. [doi:10.1090/bull/1520](https://doi.org/10.1090/bull/1520)
