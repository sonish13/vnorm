...
model {
  ...
  real dgx = bx + 2*bx2*x + bxy*y + 3 * bx3 * x^2 + 2 * bx2y * x * y + bxy2 * y^2 + 2 * bx2z * x * z + bxz2 * z^2 + bxyz*y*z;
  real dgy = by + 2*by2*y + bxy*x + 3 * by3 * y^2 + 2 * bxy2 * x * y + bx2y * x^2 + 2 * by2z * y * z + byz2 * z^2 + bxyz*x*z;
  real dgz = bz + 2*bz2*z + bxz*x + 3 * bz3 * z^2 + 2 * bxz2 * x * z + bx2z * x^2 + 2 * byz2 * y * z + by2z * y^2 + bxyz*x*y;
